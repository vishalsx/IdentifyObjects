...
# async def get_images_from_pool(limit: int = 9) -> List[Dict[str, Any]]:
#     """Returns up to `limit` translation summaries for the current user in a deterministic order."""
#     try:
...
#                 }
#             },
#             {"$sort": {"total_net_votes": -1, "_id": 1}},  # deterministic sort
...
#                     "object_name_en": obj_doc.get("object_name_en", ""),  # <- updated
...
# #-------New Search Alogo with fuzzy logic and field independent searching-----------------
# # search can now be done on any field and will return results based on best match to worst match
...
# Lightweight local synonym mapping
# SYNONYMS = {
